...
const emailPriceCards = [
                          ...
                          ,{title: 'Business', description: 'Our most effective tool for top-tier managers', price: '$50.00', billingText: '/user /month billed monthly', trial: '7 day free trial', includes: ['lorem ipsum', 'lorem sjf thwl','lorem ipsum', 'lorem sjf thwl', 'test sft test' ], buttonText: 'Sign me up', mostPopular: true}
...
const CustomGPTPriceCards = [
  {
    title: 'Basic',
    description: 'Your Personal GPT — for individuals and professionals who want a personal AI assistant that saves time and enhances productivity.',
    price: '$19.00',
  ...
  {
    title: 'Pro',
    description: 'Your Division GPT — for department heads and team leads who want an AI teammate supporting the entire group’s workflow.',
    price: '$99.00',
  ...
  {
    title: 'Enterprise',
    description: 'Your Company GPT — our white-glove service for organizations ready to implement AI across their operations.',
    price: 'Custom',
...
const StrategicIntelligencePriceCards = [
  ...
  },
  {
    ...
    description: 'For leadership teams requiring continuous strategic insight and data-driven guidance.',
    price: '$2,500',
